...
| "~5–10 min 端到端" | ⚠️ 由分阶段加总**推断**,Belle 未亲口给过总时长(docx 简历里用了此写法,可辩护但要知道出处) | Claude 推断 |
...
- ⚠️ **2025 年 9 月边界待确认**:IntelliPro 止于 9 月、Outlandish 始于 9 月——是无缝衔接还是月内并行?需 Belle 给到日级(如 IntelliPro 至 9 月上旬、Outlandish 9 月中下旬),否则简历双写 "Sep 2025" 可能被读成并行任职
