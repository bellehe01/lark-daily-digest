...
**追问弹药**:①20 个怎么选的 → 用垂类筛选框架 + 优质内容标准双重过滤,兼顾体量和示范性;②1v1 成本高怎么规模化 → 头部做深(1v1)、腰部做宽(社群+站内信+活动),头部案例反哺腰部教育素材;③和现在 Outlandish 的工作什么关系 → 同一套 creator lifecycle 方法论,规模从每垂类 20 人变成 44,000 人,靠 CRM 和自动化补人力
